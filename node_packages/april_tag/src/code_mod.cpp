...
public:
  AprilTagNode() : 
    ...
    tag_detector(NULL),
     m_width(640), 
    m_height(480),
    camera_focal_length_x(263.612),
    camera_focal_length_y(259.694),
    ...
    m_deviceId(1)
  {
   ...
   // image_sub_ = it_.subscribe("/camera/image_raw", 1, &AprilTagNode::imageCb, this);
    ...
    private_node_handle.param<double>("focal_length_px", camera_focal_length_x, 263.612);
    private_node_handle.param<double>("focal_length_py", camera_focal_length_y, 259.694);
    private_node_handle.param<double>("tag_size_cm", tag_size, 16.5);
 ...
 void imageCb(cv::VideoCapture& m_cap)
  {
